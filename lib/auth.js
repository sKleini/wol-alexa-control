...
export function keyOk(req) {
  ...
  // Ueber queryOf und nicht ueber req.query: Vercels Getter dafuer ruft
  // intern url.parse() auf und schreibt damit eine Deprecation-Warnung in
  // jedes Funktionsprotokoll (siehe lib/query.js).
  const ausQuery = queryOf(req).key;
