 ...
 *
 * **Sechs Megabyte, nicht sechzehn.** Die Function hat eine Uhr, und wie lang
 * sie laeuft, bestimmt der Tarif - auf einem Hobby-Projekt ohne Fluid Compute
 * sind es zehn Sekunden. In die muss das Stueck zweimal passen: von der Box zu
 * Vercel (das ist der Uplink des Anschlusses, der Flaschenhals) und weiter zum
 * Echo. Sechs Megabyte sind bei 10 Mbit/s Uplink rund fuenf Sekunden, bei 40
 * gut eine; sechzehn waeren bei 10 Mbit/s dreizehn - also zu spaet. Der Preis
 * sind ein paar Bereichsabrufe mehr je Titel, und die kosten nichts.
 */
const KAPPUNG_MB_VORGABE = 6;
