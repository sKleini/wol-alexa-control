...
export async function handleSkill(body, res, redis) {
  ...
  try {
    ...
    if (typ === 'IntentRequest') {
      ...
      switch (intent.name) {
        ...
        case 'AMAZON.CancelIntent':
          ...
          return haltUndMerken(body, res, playlists, redis, ausSprache(body), notiz);
    ...
    if (typ === 'PlaybackController.PauseCommandIssued') return haltUndMerken(body, res, playlists, redis, ausSprache(body), notiz);
