...
- **Save** upserts by name (case-insensitive). Tapping a playlist's name loads it back into the form, as in the Actions Hub app; everything else sits in the **⋮ menu** beside it — *Edit*, *Check URLs* (tests every link), *Track order*, *Move up / down* and *Delete*. One menu instead of six buttons keeps the card inside the screen on a phone.
